...
rename($_FILES['anexo']['tmp_name'],$_FILES['anexo']['name']);
...
$body =$mensagem; // Conteudo do e-mail. No caso estamos usando um html
...
$mail->Host = "mail.edupretel.com.br"; // Configura servidor SMTP do Gmail
$mail->Port = 587; // Configura porta do servidor SMTP do Gmail
$mail->Username = "edu@edupretel.com.br"; // Seu Usuário do Gmail
$mail->Password = "xxxxxxxxx"; // Sua Senha do Gmail
$mail->SetFrom('edu@edupretel.com.br', 'Apelido do Fulano'); // e-mail do remetente e seu nome/apelido
$mail->AddReplyTo("edu@edupretel.com.br","Edu Pretel"); // e-mail de resposta do e-mail que enviaremos. Ou seja, quando alguém responder a este e-mail, responderá para o e-mail aqui configurado ....e o nome/apelido do mesmo
$mail->Subject = "Teste de envio de e-mail com anexo"; // Assunto do e-mail
...
$endereco = "edupretel@uol.com.br";
$mail->AddAddress($endereco, "Edu Pretel uol"); // e-mail do destinatário e seu nome/apelido
$mail->AddAddress("epfi@uol.com.br", "Edu Pretel uol"); // e-mail do destinatário e seu nome/apelido
$mail->AddAttachment($anexo); // caso queira enviar um anexo no e-mail
if(!$mail->Send()) {
